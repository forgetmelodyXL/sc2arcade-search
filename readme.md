...
| 地图检测调试 [force] | 3   | 调试地图检测任务，查看API数据与存储对比 |
...
### ✨ 1.2.13
  - 简化广播通知格式：移除热度排名和最后检测时间，部分字段仅显示变更后值
  - 优化地图检测查询输出：离线地图不显示热度排名，移除最后检测时间和首次发现时间

### ✨ 1.2.10
  - 定时任务仅在地图在线状态变化时广播，忽略其他字段变化

### ✨ 1.2.8
  - 修复多 Bot 场景下广播消息发送到错误 Bot 的问题
